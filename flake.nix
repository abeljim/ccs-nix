    ...
    flake-utils.lib.eachSystem ["x86_64-linux"] (system: let
      ...
      ccstudio-unwrapped = pkgs.callPackage ({
        ...
        stdenv.mkDerivation rec {
          ...
          src = pkgs.fetchzip {
            url = "https://dr-download.ti.com/software-development/ide-configuration-compiler-or-debugger/MD-J1VdearkvK/20.4.0/CCS_20.4.0.00013_linux.zip";
            hash = "sha256-agUKN5YYffOA2/THmygnClVD6hnztrqHoHD+mC2rTeM=";
          };
